...
Version : **3.1.1** — 11 septembre 2026
...
Consulter `PRODUCTION_CHECKLIST.md` avant toute mise en ligne et `VALIDATION_V3.md` pour le détail des contrôles V3.1.1 et des validations héritées.
