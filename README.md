...
Version : **3.2.0** — 11 septembre 2026
...
Consulter `PRODUCTION_CHECKLIST.md` avant toute mise en ligne et `VALIDATION_V3.md` pour le détail des contrôles V3.2.0 et des validations héritées.
