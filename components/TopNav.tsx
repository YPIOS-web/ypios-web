...
export default function TopNav() {
  ...
  return (
    <div className="fixed inset-x-0 top-4 z-50 flex justify-center pointer-events-none">
      {/* Pillow translucide : même esprit que derrière le logo */}
      <nav
        aria-label="Navigation principale"
        className="pointer-events-auto max-w-full overflow-x-auto no-scrollbar rounded-full bg-black/55 px-2 py-1.5 shadow-md ring-1 ring-white/10 backdrop-blur-sm"
      >
